...
INSERT INTO `pre__larke_admin` VALUES ('6e5b96c8-d1f3-4d23-a016-38f994b6f9bc','larke','ec47d3facd39e00af6083e785c0cc8f8','HjESXC','larke','larke-admin@qq.com','394ce8caed5778084bda50e3699bd72e','larke测试管理员',0,1,1652454692,'127.0.0.1',1652454692,'127.0.0.1',1605712035,'127.0.0.1'),('9b09f6b6-5808-4234-a7ff-0316838ed467','admin','c0360861708df48d70630917ee1fe890','Azy1rU','管理员','larke-admin@larke-admin.com','36775816156eb936d52af3e1764a9d4a','larke-admin 是基于 laravel8 版本的后台快速开发框架，完全api接口化，适用于前后端分离的项目',1,1,1670470094,'127.0.0.1',1670301492,'127.0.0.1',1605712032,'127.0.0.1');
